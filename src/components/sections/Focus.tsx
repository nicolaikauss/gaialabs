...
const glassPill =
  "rounded-full border border-white/25 bg-white/[0.09] px-6 py-2.5 text-sm font-medium text-white/90 backdrop-blur-md shadow-[0_2px_12px_-4px_rgba(0,0,0,0.3)] ring-1 ring-inset ring-white/15 transition-all duration-200 hover:bg-white/[0.15] hover:text-white hover:border-white/40";
