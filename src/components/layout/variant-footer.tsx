  ...
  return (
    <footer className="w-full border-t border-white/[0.06] bg-black">
        ...
        <div className="grid gap-10 md:grid-cols-[1.5fr_1fr_1fr]">
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <p className="text-xs text-white/30">{site.parent}</p>
            </div>
          ...
          <div className="flex flex-col gap-3">
            <p className="text-[10px] font-semibold uppercase tracking-widest text-white/30">Navigate</p>
            {site.nav.map((link) => (
              <Link
                key={link.href}
                href={link.href}
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-xs text-white/25">Gaia Capital · {new Date().getFullYear()}</p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-white/[0.05]">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-6 py-5 text-xs text-white/25 sm:flex-row lg:px-8">
