...
export function BeamsBackground({
  ...
  vec3 getNormal(vec3 pos) {
    ...
    float randomNoise = fract(sin(dot(gl_FragCoord.xy, vec2(12.9898,78.233))) * 43758.5453);
...
export function BeamsStaticFallback({ className }: { className?: string }) {
  return (
    <div
      className={className}
      style={{
        background:
          "radial-gradient(ellipse 80% 60% at 50% 0%, rgba(52, 211, 153, 0.25), transparent 60%), linear-gradient(180deg, #0f172a 0%, #020617 100%)",
      }}
    />
  );
}
